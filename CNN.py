...
plt.title('Superalloys_CNN_lgRT',fontsize=14,fontproperties='Times New Roman',fontweight='bold')
plt.rcParams['font.sans-serif']=['Times New Roman']
plt.rcParams['axes.unicode_minus'] = False
plt.scatter(pre_source, y_test_source,color='orange',label='test')
plt.scatter(pre2_source, y_train,color='blue',label='train')
plt.plot([0, 6], [0, 6], '--')
plt.xlim((0, 6))
plt.ylim((0, 6))
